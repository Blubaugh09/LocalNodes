...
<div id="categoryContainer" style="position: fixed; bottom: 10px; left: 10px; background-color: #f0f0f0; padding: 10px; border-radius: 5px;">
...
function zoomIn() {
    var zoomIncrement = 0.1; // Define how much you want to zoom each time
    ...
    $(go.Node, "Auto",
        ...
        $(go.Panel, "Table",
         ...
         $("Panel",
            ...
            $("Button",
                { click: function(e, obj) { callUser(obj.part.data.phone); } },
                $(go.TextBlock, "Call")
            )
        ),
        ...
        $("Panel",
            ...
            new go.Binding("visible", "showButtons"), // Visibility bound to a property
            $("Button",
                { click: function(e, obj) { emailUser(obj.part.data.email); } },
                $(go.TextBlock, "Email")
            )
        ),
